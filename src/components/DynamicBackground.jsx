...
const words = ["el", "futuro", "del", "marketing", "es", "ahora."];
...
export default function DynamicBackground() {
  ...
  const wordItems = words.map((w, i) => ({
    text: w,
    top: `${15 + i * 14}%`, 
    left: i % 2 === 0 ? '-5%' : '65%', // Distribute left / right slightly hiding on edges
    speed: (i % 2 === 0 ? 0.1 : 0.15) // Moves faster downwards relative to scroll
  }));
